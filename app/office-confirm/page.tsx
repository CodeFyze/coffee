    ...
    <div>
      ...
      <div className="container mx-auto px-4 sm:px-0 py-8 mt-5">
          ...
          <div className="bg-gray-100 text-center py-6">
            <div className="py-6">
              ...
              <p className="text-[18px] text-[#BD1521] font-bold pt-4 px-5 mb-0 font-['Apercu-Medium']">
                Thanks for getting in touch we will get back to you as soon as
                possible
              </p>
            </div>
          </div>
        ...
        <div className="my-8 sm:my-6">
          {/* <p className="text-[14px] text-[#BD1521] text-center uppercase mb-6 font-['Apercu-Medium']">
                        in the meantime
                    </p> */}
          <div className="mx-auto pt-4 sm:pt-6 max-w-[600px] px-4 sm:px-0">
            ...
            <div className="pt-4">
              <div className="text-center">
                <button
                  onClick={handleNext}
                  className="w-full sm:w-[400px] bg-[#BD1521] text-white py-4 px-8 uppercase font-['Apercu-Medium'] mt-2 sm:mt-0 hover:bg-[#97474d] transition-colors"
                >
                  Return to homepage
                </button>
              </div>
