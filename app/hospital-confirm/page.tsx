            ...
            <div className="container mx-auto px-4 sm:px-0 py-8 mt-5">
                ...
                <div className="my-6">
                    <div className="container mx-auto">
                        <h1 className="text-[26px] font-bold text-[#BD1521] text-center uppercase m-0 font-['Apercu-Medium']">
                            Message Sent
                        </h1>
                    </div>
                </div>
                ...
                <div className="container mx-auto py-8 sm:py-5 max-w-[500px] px-4 sm:px-0">
                    <div className="bg-gray-100 text-center py-6">
                        <div className="py-6">
                            ...
                            <p className="text-[18px] text-[#BD1521] font-bold pt-4 px-5 mb-0 font-['Apercu-Medium']">
                    ...
                    <div className="mx-auto pt-4 sm:pt-6 max-w-[600px] px-4 sm:px-0">
                        {/* <div className="pt-4">
                            <div className="text-center">
                                <button className="w-full sm:w-[400px] bg-[#BD1521] text-white py-4 px-8 uppercase font-['Apercu-Medium'] mt-2 sm:mt-0 hover:bg-[rgb(39,74,79)] transition-colors">
                                    Read our blog
                                </button>
                            </div>
                        </div> */}
                        <div className="pt-4">
                            <div className="text-center">
                                <button onClick={handleNext} className="w-full sm:w-[400px] bg-[#BD1521] text-white py-4 px-8 uppercase font-['Apercu-Medium'] mt-2 sm:mt-0 hover:bg-[#94494f] transition-colors">
                                    Return to homepage
                                </button>
                            </div>
                        </div>
