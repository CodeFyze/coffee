...
export default function BusinessInfo() {
	...
	return (
		<div className='relative w-full min-h-screen font-sans flex flex-col items-center pb-6 bg-white text-[#BD1521]'>
			...
			<h2 className='text-center text-2xl md:text-3xl font-bold mb-6 mt-10'>Tell us about your business</h2>
			...
			<div className='text-center w-full'>
				...
				<input
					...
					className='mt-2 border-b-2 border-[#BD1521] outline-none text-center w-full max-w-md p-2 text-[#BD1521] placeholder-gray-400'
				/>
			</div>
