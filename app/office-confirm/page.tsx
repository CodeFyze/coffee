            ...
            <div className="container mx-auto px-4 sm:px-0 py-8 mt-5">
                ...
                <div className="my-8 sm:my-6">
                    ...
                    <div className="mx-auto pt-4 sm:pt-6 max-w-[600px] px-4 sm:px-0">
                        ...
                        <div className="pt-4">
                            <div className="text-center">
                                <button onClick={handleNext} className="w-full sm:w-[400px] bg-[#BD1521] text-white py-4 px-8 uppercase font-['Apercu-Medium'] mt-2 sm:mt-0 hover:bg-[#97474d] transition-colors">
                                    Return to homepage
                                </button>
                            </div>
                        </div>
